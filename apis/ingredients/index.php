...
// primeira leitura //
$arquivo = "https://www.thecocktaildb.com/api/json/v1/1/filter.php?i=$filter";
$info = my_file_get_contents($arquivo);
$lendo = json_decode($info);
foreach($lendo->drinks as $campo){;
?>

    <div style="float: left; width: 200px; height: 300px; background: #dddddd; padding:4px;border-style: solid;border-color: #ffffff;"><img src="<?php print_r($campo->strDrinkThumb);?>" width="200px" height="200px"/>
